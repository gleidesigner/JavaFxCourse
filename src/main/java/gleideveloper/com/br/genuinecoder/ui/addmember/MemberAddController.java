...
public class MemberAddController extends MessageAlert implements Initializable {
    ...
    public void addMember(ActionEvent actionEvent) {
        ...
        if(flag){
            ...
            getAlertError(Alert.AlertType.ERROR, "Please Enter the fields");
            return;
        }
        ...
        if(handler.execAction(sql)){
            //Metodo Alert herdado da classe abastrata MessageAlert
            getAlertError(Alert.AlertType.INFORMATION, "Save");
        }/*else{
            //Metodo Alert herdado da classe abastrata MessageAlert
            getAlertError(Alert.AlertType.ERROR, "Error Occured");
        }*/
    }
